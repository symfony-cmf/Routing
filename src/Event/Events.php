...
final class Events
{
     ...
     */
    public const PRE_DYNAMIC_MATCH = 'cmf_routing.pre_dynamic_match';
     ...
     * The event object is RouterMatchEvent.
     */
    public const PRE_DYNAMIC_MATCH_REQUEST = 'cmf_routing.pre_dynamic_match_request';
     ...
     */
    public const PRE_DYNAMIC_GENERATE = 'cmf_routing.pre_dynamic_generate';
}
